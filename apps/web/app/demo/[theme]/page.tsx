...
// Public, no-auth, no-payment live demos — one per theme. These let prospective
// buyers experience the real product before paying (a major conversion lever)
// and give the marketing site working "View Demo" links.
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!meta) return { title: "Demo — Just4You" };
  return {
    title: `${meta.label} Theme — Live Demo | Just4You.buzz`,
    description: `Experience the ${meta.label} celebration website theme live. ${meta.description}`,
  };
}
...
export default async function DemoThemePage({ params }: Props) {
  ...
  return (
    <>
      <AnalyticsBeacon event="demo_viewed" props={{ theme }} />
